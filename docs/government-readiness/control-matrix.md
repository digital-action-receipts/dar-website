...
| WS1-07 | Limitations and prohibited early-pilot data | Founder / privacy | `pilot-boundaries.md` | Evidenced as proposed rules; not technically enforced | Approval, training, schema rejection tests |
...
| PR-01 | Purpose limitation and minimization | Privacy owner | `data-inventory.md`, `pilot-boundaries.md` | Partial: design copy favors hashes/pseudonyms; no enforcement | Approved schema and prohibited-field tests |
...
| RR-01 | Retention/immutability architecture decision | Records owner | ADR-0001 | Proposed; founder approval required; no implementation | Approved ADR and architecture review |
| RR-02 | Configurable retention and legal hold | Records/engineering | ADR-0001 requirements | Not implemented | Expiry/hold/release authorization tests |
...
| RR-04 | Authorized deletion/cryptographic erasure and disposition receipt | Records/security | ADR-0001 requirements | Not implemented | Deletion, backup-expiry, audit, sample disposition receipt |
...
| PP-01 | Low-risk pilot eligibility and prohibited uses | Founder | `pilot-boundaries.md` | Proposed; founder approval required | Signed pilot readiness checklist |
